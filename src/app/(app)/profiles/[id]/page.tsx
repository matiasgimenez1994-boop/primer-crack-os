    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 flex flex-col gap-4">
          ...
          <div className="card p-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <div key={label} className={`p-3 rounded-xl text-center ${highlight ? "bg-[#F5EFE6]" : "bg-[#FDFAF6]"}`}>
          ...
          {/* Resultado en taza */}
          {(profile.cup_result || profile.recommendation) && (
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {(batches ?? []).map((b: RoastBatch) => (
                      <tr key={b.id} className="border-b border-border-default last:border-0 hover:bg-[#F5EFE6]/50">
